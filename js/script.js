...
new Chart(chart, {
    ...
    data: {
        ...
        datasets: [
            {
                label: 'BTC',
                data: [29374, 33537, 49631, 59095, 57828, 36684, 33572, 39974, 48847, 48116, 61004, 81004],
                borderColor: 'Red',
                borderWidth: 2
            },
            {
                label: 'ETH',
                data: [31500, 41000, 88800, 26000, 46000, 32698, 5000, 3000, 18656, 24832, 36844, 40844],
                borderColor: 'blue',
                borderWidth: 2
            },
            {
                label: 'MTC',
                data: [10000, 20000, 34200, 72000, 84000, 52698, 20000, 60000, 40000, 70832, 88000, 55555],
                borderColor: 'green',
                borderWidth: 2
            }
        ]
